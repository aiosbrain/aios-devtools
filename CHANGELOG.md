...
- Declare and continuously test the portable CLI Node contract on majors 22, 24, and 26
  (`22.x || 24.x || 26.x`). The foundation dependency floor is now `^0.1.2`, excluding
  the older `0.1.0` manifest that warned on Node 24 and 26. Runtime and provider behavior
  are unchanged. (AIO-1066)
...
[0.3.1]: https://github.com/aiosbrain/aios-devtools/compare/v0.3.0...v0.3.1
